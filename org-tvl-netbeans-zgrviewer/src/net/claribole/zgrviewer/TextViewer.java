/*
 * FILE: TextViewer.java DATE OF CREATION: Wed Dec 03 09:31:46 2003 Copyright
 ...
 *
 * $Id: TextViewer.java 4276 2011-02-25 07:47:51Z epietrig $
 */
...
/*
 * A simple text viewer that displays the content of a stringbuffer. Can be set
 * to automatically update its content periodically. Can be used for showing
 * error logs, raw source files,...
 */
public final class TextViewer extends JFrame implements ActionListener, KeyListener, Runnable {
     ...
     * @param d periodic update (in milliseconds) of the main area w.r.t msgs
     * (0=no update)
    ...
    public void run() {
        ...
        while (runView == me) {
            ...
            }  //update text only if new error messages
            oldSize = text.length();
            try {
                Thread.sleep(period);
