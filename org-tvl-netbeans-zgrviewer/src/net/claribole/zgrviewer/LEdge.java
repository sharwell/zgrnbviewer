/*
 * FILE: LEdge.java DATE OF CREATION: Thu Mar 15 19:18:17 2007 Copyright (c)
...
public class LEdge extends LElem {
    ...
    public ClosedShape getArrowHead() {
        for (int i = 0; i < glyphs.length; i++) {
            if (glyphs[i] instanceof VShape) {
                return (VShape)glyphs[i];
            } else if (glyphs[i] instanceof VPolygon) {
                return (VPolygon)glyphs[i];
            }
        }
        return null;
    }
