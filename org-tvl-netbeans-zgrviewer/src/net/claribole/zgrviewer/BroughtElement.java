/*
 * FILE: LNode.java Copyright (c) INRIA, 2008-2010. All Rights Reserved Licensed
 * under the GNU LGPL. For full terms see the file COPYING.
 *
 * $Id: BroughtElement.java 3894 2010-10-03 14:34:13Z epietrig $
 */
...
abstract class BroughtElement {
    ...
    static BroughtElement rememberPreviousState(LElem el) {
        if (el instanceof LNode) {
            return new BroughtNode((LNode)el);
        } else if (el instanceof LEdge) {
    ...
    public static class BroughtNode extends BroughtElement {
    ...
    public static class BroughtEdge extends BroughtElement {
