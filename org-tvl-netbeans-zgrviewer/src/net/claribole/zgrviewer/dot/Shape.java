/*
 * FILE: Shape.java DATE OF CREATION: Apr 4 2005 AUTHOR : Eric Mounhem
...
public class Shape {
    ...
    /**
     * One of the following GraphViz' shape: <ul> <li>NONE</li> <li>NORMAL</li>
     * <li>INV</li> <li>BOX</li> <li>CROW</li> <li>DIAMOND</li> <li>DOT</li>
     * <li>TEE</li> <li>VEE</li> </ul>
     */
    int shape;
    /**
     * Side of the shape to draw. May be BOTH, LEFT or RIGHT. BOTH by default.
     */
    int side;
    /**
     * Use a filled shape
