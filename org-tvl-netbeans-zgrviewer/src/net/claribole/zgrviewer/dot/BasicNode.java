/*
 * FILE: BasicNode.java DATE OF CREATION: Apr 4 2005 AUTHOR : Eric Mounhem
...
public class BasicNode extends CommonNode {
    /*
     * CIRCLE = ELLIPSE + regular PARALLELOGRAM = POLYGON + sides=4 + skew=0.6
     * TRIANGLE = POLYGON + sides=3 [HEX|OCT|SEPT|...]AGON = POLYGON +
     * sides=[6|8|7|...] [DOUBLE|TRIPLE]x = x + peripheries=[3|4] DIAMOND =
     * POLYGON + regular + orientation=45
     */
    /*
     * Polygons
     */
    ...
    /**
     * Type of node shape. One of the following: <ul> <li>USER</li>
     * <li>NONE</li> <li>ELLIPSE</li> <li>POLYGON</li> <li>POINT</li>
     * <li>EGG</li> <li>DIAMOND (not anymore)</li> <li>TRAPEZIUM</li>
     * <li>PARALLELOGRAM</li> <li>HOUSE</li> <li>INVTRIANGLE</li>
     * <li>INVTRAPEZIUM</li> <li>INVHOUSE</li> </ul>
     */
    int shape = ELLIPSE;
    /**
     ...
     *
     * @param root parent graph
     * @param id identificator of the node
     * @throws Exception Exception thrown when no ID is given
     */
    ...
    private void getAttributes(BasicNode node) {
        ...
        if (this.layer != null && node.layer != null) {
            if (!Arrays.equals(this.layer, node.layer)) {
        ...
        if (this.vertices != null && node.vertices != null) {
            if (!Arrays.equals(this.vertices, node.vertices)) {
    ...
    private void getGenericAttributes() {
        ...
        for (int i = roots.size() - 1; i == 0; i--) {
            BasicNode generic = (roots.get(i)).genericNode;
            if (generic != null) {
