/*
 * FILE: Style.java DATE OF CREATION: Apr 4 2005 AUTHOR : Eric Mounhem
...
/**
 * Specifies a node or edge style. It can be one of the predefined style or a
 * new one, which can have attributes
 *
 * @author Eric Mounhem
 */
public class Style {
     ...
     *
     * @param style one of the following: <ul> <li>DASHED</li> <li>DOTTED</li>
     * <li>SOLID</li> <li>INVIS</li> <li>BOLD</li> <li>FILLED</li>
     * <li>DIAGONALS</li> <li>ROUNDED</li> </ul>
     ...
     *
     * @param s One of the following style: <ul> <li>DASHED</li> <li>DOTTED</li>
     * <li>SOLID</li> <li>INVIS</li> <li>BOLD</li> <li>FILLED</li>
     * <li>DIAGONALS</li> <li>ROUNDED</li> </ul>
