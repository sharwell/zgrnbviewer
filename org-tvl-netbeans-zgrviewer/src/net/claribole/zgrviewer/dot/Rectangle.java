/*
 * FILE: Rectangle.java DATE OF CREATION: Apr 4 2005 AUTHOR : Eric Mounhem
...
public class Rectangle {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 89 * hash + (int)(this.x1 ^ (this.x1 >>> 32));
        hash = 89 * hash + (int)(this.x2 ^ (this.x2 >>> 32));
        hash = 89 * hash + (int)(this.y1 ^ (this.y1 >>> 32));
        hash = 89 * hash + (int)(this.y2 ^ (this.y2 >>> 32));
        return hash;
    }
