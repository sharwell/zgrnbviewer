/*
 * FILE: Graph.java DATE OF CREATION: Apr 4 2005 AUTHOR : Eric Mounhem
...
/**
 * Root of a GraphViz graph. This class contains global variables used for many
 * purpose: layout, order...
 *
 * @author Eric Mounhem
 */
public class Graph {
    ...
    public void addEdge(Edge edge) {
        if (this.edges == null) {
            ...
            for (int i = 0; i < this.edges.length; i++) {
                addEdge &= !(this.edges[i].start.equals(edge.start) && this.edges[i].end.equals(edge.end));
                if (!addEdge) {
                    break;
                }
            }
     ...
     * root's type
     *
     * @param root Root element to add the node
    ...
    public static void addNode(Object root, Node element) {
        ...
        /*
         * if (root instanceof Graph) { ((Graph) root).addNode(element); } else
         * if (root instanceof SubGraph) { ((SubGraph) root).addNode(element);
         }
         */
    }
    ...
    public void addFontPath(String path) {
        if (this.fontpath == null) {
            ...
            if (add) {
                ...
                System.arraycopy(this.fontpath, 0, tmp, 0,
    ...
    public void changeOption(String name, String value) {
            ...
            || name.equals("resolution")) // resolution
        {
            ...
            {
                this.truecolor = DotUtils.readBoolean(v);
    ...
    private String printOption(String attribute, Color value) {
        if (value != null) {
            String r = Integer.toHexString(value.getRed()), g = Integer.toHexString(value.getGreen()), b = Integer.toHexString(value.getBlue()), a = Integer.toHexString(value.getAlpha());
            if (r.length() == 1) {
                r = "0" + r;
            }
            if (g.length() == 1) {
