/*
 * FILE: Edge.java DATE OF CREATION: Apr 4 2005 AUTHOR : Eric Mounhem
...
public final class Edge {
    ...
    /**
     * Direction of the edge, one of the following: <ul> <li>FORWARD</li>
     * <li>BACK</li> <li>BOTH</li> <li>NONE</li> </ul>
     */
    int dir;
    /**
     ...
     *
     * @param style one of the following: <ul> <li>Node.DASHED</li>
     * <li>Node.DOTTED</li> <li>Node.SOLID</li> <li>Node.INVIS</li>
     * <li>Node.BOLD</li> </ul>
     ...
     *
     * @param s One of the following style: <ul> <li>Node.DASHED</li>
     * <li>Node.DOTTED</li> <li>Node.SOLID</li> <li>Node.INVIS</li>
     * <li>Node.BOLD</li> </ul>
     ...
     *
     * @param rootGraph Root of the graph
     * @param start Starting node
     * @param end Ending node
     */
    /*
     * public Edge(Graph rootGraph, Node start, Node end) { this.rootGraph =
     * rootGraph; this.dir = (rootGraph.directed) ? FORWARD : NONE;
     * setStart(start); setEnd(end); rootGraph.addEdge(this); }
     *
     * public Edge(SubGraph rootGraph, Node start, Node end) { this.rootGraph =
     * rootGraph; this.dir = (rootGraph.getRootGraph().directed) ? FORWARD :
     * NONE; setStart(start); setEnd(end); rootGraph.addEdge(this); }
     */
    ...
    private void getAttributes(Edge edge) {
        ...
        if (this.color != null) {
            if (!Arrays.equals(this.color, edge.color)) {
        ...
        if (this.layer != null) {
            if (!Arrays.equals(this.layer, edge.layer)) {
    ...
    private void getGenericAttributes() {
        ...
        List<SubGraph> roots = new ArrayList<SubGraph>();

        while (root instanceof SubGraph) {
            roots.add((SubGraph)root);
        ...
        for (int i = roots.size() - 1; i == 0; i--) {
            Edge generic = (roots.get(i)).genericEdge;
            if (generic != null) {
     ...
     */ {
         ...
         * else if (name.equals("id")) { // XXX: don't know this attribute }
         */ else {
    ...
    private String edgeOptions() {
        ...
        if (!this.samehead.isEmpty()) {
            o += printOption("samehead", this.samehead);
        }
        if (!this.sametail.isEmpty()) {
    ...
    private String printOption(String attribute, Spline value) {
        String o = attribute + "=\"";
        /*
         * for (int i = 0; i < value.length; i++) { if (i > 0) o += "; "; o +=
         * value[i]; }
         */
        return o + value + "\" ";
    }
