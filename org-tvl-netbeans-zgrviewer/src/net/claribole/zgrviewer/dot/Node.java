/*
 * FILE: Node.java DATE OF CREATION: Apr 4 2005 AUTHOR : Eric Mounhem
...
abstract public class Node {
    ...
    int peripheries = 1;
    /**
     * Don't justify multiline labels
     */
     ...
     * @param id identification string of the node in the graph
     * @throws Exception the node must have an ID (unless it is a SubRecord
     * node)
     */
    public Node(Object root, String id) throws Exception {
        if (id.isEmpty() && !(this instanceof SubRecord)) {
    ...
    protected Node(Object root) throws Exception {
        /*
         * if (id.equals("") && !(this instanceof SubRecord)) throw new
         * Exception("No ID"); this.id = id;
         */
        this.root = root;
    }
    ...
    protected String nodeOptions() {
        String o = " ";
        if (this.label != null) {
            if (!this.label.isEmpty() && !this.label.equals(this.id)) {
