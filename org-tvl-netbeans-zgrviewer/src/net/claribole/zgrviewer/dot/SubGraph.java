/*
 * FILE: SubGraph.java DATE OF CREATION: Apr 4 2005 AUTHOR : Eric Mounhem
 * (skbo@lri.fr) Copyright (c) INRIA, 2004-2007. All Rights Reserved Licensed
 * under the GNU LGPL. For full terms see the file COPYING.
 *
...
public class SubGraph extends Node {
     ...
     * @param id identifier of the subGraph
     * @throws Exception
     */
    ...
    /**
     * Specifies the character encoding used. One of the following: <ul>
     * <li>UTF_8</li> <li>ISO_8859_1</li> </ul>
     */
    //int charset = UTF_8;
    /**
     * Mode used for handling clusters. May be one of the following: <ul>
     * <li>NONE</li> <li>GLOBAL</li> <li>LOCAL</li> </ul>
     */
    ...
    /**
     * How the distance matrix is computed. May be one of the following: <ul>
     * <li>SHORTPATH</li> <li>CIRCUIT</li> <li>SUBSET</li> </ul>
     */
     ...
     * <ul> <li>NO_ORDERING</li> <li>IN</li> <li>OUT</li> </ul>
     */
    int ordering = Graph.NO_ORDERING;
    /**
     * Specify drawing order of nodes and edges. One of the following: <ul>
     * <li>BREADTHFIRST</li> <li>NODESFIRST</li> <li>EDGESFIRST</li> </ul>
     */
    int outputorder = Graph.BREADTHFIRST;
    /**
     * How node overlaps are removed. May be one of the following: <ul>
     * <li>RETAIN</li> <li>SCALE</li> <li>VORONOI</li> <li>SCALEXY</li>
     * <li>ORTHOXY</li> <li>ORTHOYX</li> <li>COMPRESS</li> </ul>
     */
    int overlap = Graph.RETAIN;
    /**
     * Used to activate or deactivate packing. -1: false >0: true with the value
     * as a margin (0: true, with the margin at 8...)
     */
    boolean pack = false;
    /**
     * Packing method to use. May be one of the following: <ul> <li>NODE</li>
     * <li>CLUST</li> <li>GRAPH</li> </ul>
     */
     ...
     * following: <ul> <li>BL</li> <li>BR</li> <li>TL</li> <li>TR</li>
     * <li>RB</li> <li>RT</li> <li>LB</li> <li>LT</li> </ul>
     */
    ...
    double quantum = 0;
    /**
     * Direction of graph layout. One of the following: <ul> <li>TB</li>
     * <li>LR</li> <li>BT</li> <li>RL</li> </ul>
     */
    ...
    double ranksep;
    /**
     * Desired aspect ratio. May also be one of the following: <ul>
     * <li>NO_RATIO</li> <li>FILL</li> <li>COMPRESS_RATIO</li> <li>EXPAND</li>
     * <li>AUTO</li> </ul>
     */
    ...
    Point2D.Double size;
    /**
     * Method of drawing edges. May be one of the following: <ul>
     * <li>NO_SPLINES</li> <li>SPLINES</li> <li>COMPOUND</li> </ul>
     */
    ...
    /**
     * Control node placement at start. May be one of the following: <ul>
     * <li>REGULAR</li> <li>SELF</li> <li>RANDOM</li> </ul>
     */
     ...
     *
     * @param node Node to remove (if it's in the list)
     */
     ...
     *
     * @param edge Edge to remove (if it's in the list)
     */
    ...
    public void changeOption(String name, String value) throws Exception {
        try {
             ...
             * else if (name.equals("center")) this.center =
             * DotUtils.readBoolean(v); else if (name.equals("charset"))
             * this.charset = readAttributeNumber(v); else if
             * (name.equals("clusterrank")) this.clusterrank =
             * readAttributeNumber(v); else if (name.equals("compound"))
             * this.compound = DotUtils.readBoolean(v);
             */ else if (name.equals("concentrate")) {
                this.concentrate = DotUtils.readBoolean(v);
            } /*
             * else if (name.equals("damping")) this.damping = DotUtils.readDouble(v);
             ...
             * resolution this.dpi = DotUtils.readDouble(v); else if
             * (name.equals("epsilon")) this.epsilon = DotUtils.readDouble(v);
             ...
             * else if (name.equals("k")) this.k = DotUtils.readDouble(v);
             ...
             * else if (name.equals("layers")) addLayer(v); else if
             * (name.equals("layersep")) this.layersep = v;
             */ else if (name.equals("lp")) {
                this.lp = DotUtils.readPoint(v);
            } /*
             * else if (name.equals("margin")) this.margin = DotUtils.readPointf(v);
             */ /*
             * else if (name.equals("maxiter")) this.maxiter =
             * DotUtils.readInteger(v); else if (name.equals("mclimit"))
             * this.mclimit = DotUtils.readDouble(v); else if
             * (name.equals("mindist")) this.mindist = DotUtils.readDouble(v);
             * else if (name.equals("mode")) this.mode = readAttributeNumber(v);
             * else if (name.equals("model")) this.model = readAttributeNumber(v);
            ...
            } else if (name.equals("ratio")) //System.err.println("ratio read");
            {
                 ...
                 * else if (name.equals("splines")) this.splines = readAttributeNumber(v);
                 ...
                 * else if (name.equals("truecolor")) this.truecolor = new Boolean(DotUtils.readBoolean(v));
                 */ // FIXME: test at end
                else if (name.equals("URL") || name.equals("href")) {
                    this.URL = v;
                } /*
                 * else if (name.equals("viewport")) this.viewPort = DotUtils.readViewPort(v);
