/*
 * FILE: Record.java DATE OF CREATION: Apr 4 2005 AUTHOR : Eric Mounhem
...
public class Record extends CommonNode {
    ...
    Rectangle[] rects;
    /**
     * List of the Record's elements that can be used on edges' start and ending
     * nodes
     */
     ...
     * @param id identificator of the Record
     * @throws Exception
     */
    ...
    private void getAttributes(Record record) {
        ...
        if (this.rects != null && record.rects != null) {
            if (Arrays.equals(this.rects, record.rects)) {
        ...
        if (this.layer != null && record.layer != null) {
            if (!Arrays.equals(this.layer, record.layer)) {
        ...
        if (this.vertices != null && record.vertices != null) {
            if (!Arrays.equals(this.vertices, record.vertices)) {
    ...
    private void getGenericAttributes() {
        ...
        for (int i = roots.size() - 1; i == 0; i--) {
            Record generic = (roots.get(i)).genericRecord;
            if (generic != null) {
     ...
     *
     * @param subRecord SubRecord to add
     */
    public void addSubRecord(SubRecord subRecord) {
        if (this.subRecords == null) {
            ...
            System.arraycopy(this.subRecords, 0, tmp, 0,
     ...
     *
     * @param subRecord SubRecord to remove
     */
    ...
    /**
     * @param rounded The rounded value to set.
     */
    ...
    protected String printRecordLabel() {
        ...
        if (this.subRecords != null) {
            for (int i = 0; i < this.subRecords.length; i++) {
                ...
                if (!this.subRecords[i].id.isEmpty()) {
