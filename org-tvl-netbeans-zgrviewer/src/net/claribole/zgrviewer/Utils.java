...
//    }
    ...
    /**
     * tells whether the current JVM is version 1.4.0 and later (or not)
     */
	...
	catch (Exception e){Exceptions.printStackTrace(e);return null;}
        return f;
    }
	...
	try {
	    ...
	    if (!validation){factory.setAttribute("http://apache.org/xml/features/nonvalidating/load-external-dtd", false);}
	    factory.setNamespaceAware(true);
	    DocumentBuilder builder=factory.newDocumentBuilder();
	    Document res=builder.parse(new FileInputStream(f));
	    return res;
	}
	catch (FactoryConfigurationError e){Exceptions.printStackTrace(e);return null;}
	catch (ParserConfigurationException e){Exceptions.printStackTrace(e);return null;}
	catch (SAXException e){Exceptions.printStackTrace(e);return null;}
