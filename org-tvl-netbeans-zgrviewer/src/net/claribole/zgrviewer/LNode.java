/*
 * FILE: LNode.java DATE OF CREATION: Thu Mar 15 19:18:17 2007 Copyright (c)
 * INRIA, 2007-2011. All Rights Reserved Licensed under the GNU LGPL. For full
 * terms see the file COPYING.
 *
 * $Id: LNode.java 4582 2011-07-26 10:25:17Z epietrig $
 */
...
public class LNode extends LElem {
    ...
    /**
     * Get all arcs incoming or outgoing from this node, except for the
     * specified one.
     */
    ...
    public ClosedShape getShape() {
        for (int i = 0; i < glyphs.length; i++) {
            if (glyphs[i] instanceof ClosedShape) {
                return (ClosedShape)glyphs[i];
            }
        }
        return null;
    }
