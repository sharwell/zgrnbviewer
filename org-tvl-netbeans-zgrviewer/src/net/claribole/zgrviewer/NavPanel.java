/*
 * FILE: ZGRApplet.java DATE OF CREATION: Fri May 09 09:52:34 2003 Copyright (c)
 * Emmanuel Pietriga, 2002-2011. All Rights Reserved Licensed under the GNU
 * LGPL. For full terms see the file COPYING.
 *
 * $Id: NavPanel.java 4316 2011-03-04 12:42:03Z epietrig $
 */
...
class NavPanel extends JPanel implements ActionListener, ChangeListener {
    ...
    NavPanel(GraphicsManager gm, String initialSearchString, boolean displayOverview) {
        ...
        if (displayOverview) {
            ...
            grMngr.rView.setBackgroundColor(ConfigManager.backgroundColor);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (o == zoomBts[0]) {
            ...
            grMngr.translateView(GraphicsManager.MOVE_UP_LEFT);
        } else if (o == panBts[2]) {
            grMngr.translateView(GraphicsManager.MOVE_UP_RIGHT);
        } else if (o == panBts[6]) {
            grMngr.translateView(GraphicsManager.MOVE_DOWN_LEFT);
        } else if (o == panBts[8]) {
            grMngr.translateView(GraphicsManager.MOVE_DOWN_RIGHT);
        } else if (o == aboutBt) {
            grMngr.zapp.about();
        }
    }
    ...
    public static class SearchPanel extends JPanel implements ActionListener, KeyListener {
