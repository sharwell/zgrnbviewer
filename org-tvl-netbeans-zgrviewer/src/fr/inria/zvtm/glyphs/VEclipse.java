 ...
 * file COPYING.
 *
 * $Id: VEclipse.java 4557 2011-06-29 22:15:32Z epietrig $
 */
...
public class VEclipse extends VCircle {
    ...
    public boolean coordInside(int jpx, int jpy, int camIndex, double cvx, double cvy) {
        if (((ProjEclipse)pc[camIndex]).eclipsed.contains(jpx, jpy) && ((ProjEclipse)pc[camIndex]).shadowSource.contains(jpx, jpy)) {
            return true;
        } else {
            return false;
        }
