/*
 * FILE: VRoundRect.java DATE OF CREATION: Wed May 28 14:27:51 2003 AUTHOR :
 * Emmanuel Pietriga (emmanuel@w3.org) MODIF: Emmanuel Pietriga
 * (emmanuel.pietriga@inria.fr) Copyright (c) Emmanuel Pietriga, 2002-2010. All
 * Rights Reserved Copyright (c) INRIA, 2004-2009. All Rights Reserved Licensed
...
/**
 * Round Rectangle. <br>Corners are approximated to right angles for some
 * operations such as cursor entry/exit events.
 *
 * @author Emmanuel Pietriga
 * @see fr.inria.zvtm.glyphs.VRectangle
 */
public final class VRoundRect extends ClosedShape implements RectangularShape {
    ...
    /**
     * Horizontal diameter of the arc at the four corners. MADE PUBLIC FOR
     * OUTSIDE PACKAGE SUBCLASSING.
     */
    public double arcWidth;
    /**
     * Vertical diameter of the arc at the four corners. MADE PUBLIC FOR OUTSIDE
     * PACKAGE SUBCLASSING.
     */
