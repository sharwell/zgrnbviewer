 ...
 * Automatique), 2010. Licensed under the GNU LGPL. For full terms see the file
 * COPYING.
 *
 */
...
public class Composite extends Glyph {
    ...
    /**
     * Adds a child Glyph to this Composite. Do <i>not</i> add the children to
     * the virtual space.
     *
     ...
     * @return
     * <code>true</code> if child has been removed,
    ...
    /**
     * Returns part of the internal state of this Composite. Look, but do not
     * touch!
     */
    ...
    /**
     * Re-computes the bounds of this Composite. This method is called
     * automatically after external operations affecting the Composite size
     * (such as adding or deleting a child) but should be called manually after
     * modifying a child's size or position.
     */
