 ...
 * 2010-2011. All Rights Reserved Licensed under the GNU LGPL. For full terms
...
/**
 * Wrapper for Swing components. <p>Example:</p>
 * <pre>
 ...
 */
public final class VSwingComponent extends ClosedShape implements RectangularShape {
    ...
    /**
     * Set to false if the Swing component should not be scaled according to
     * camera's altitude. Its size can still be changed, but its apparent size
     * will always be the same, no matter the camera's altitude.
     *
     * @see #isZoomSensitive()
     */
    ...
    /**
     * Indicates whether the Swing component is scaled according to camera's
     * altitude.
     *
    ...
    /**
     * Utility function: to ensure proper display, it is necessary to set the
     * size of 'standalone' Components, or to force the layout of Containers.
     *
