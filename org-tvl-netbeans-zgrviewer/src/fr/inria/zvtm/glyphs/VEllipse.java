/*
 * FILE: VEllipse.java DATE OF CREATION: Oct 14 2001 AUTHOR : Emmanuel Pietriga
 * (emmanuel.pietriga@xrce.xerox.com) Copyright (c) Xerox Corporation,
 * XRCE/Contextual Computing, 2002. All Rights Reserved Copyright (c) INRIA,
...
public class VEllipse extends ClosedShape implements RectangularShape {
    ...
    public boolean coordInside(int jpx, int jpy, int camIndex, double cvx, double cvy) {
        if (pc[camIndex].ellipse.contains(jpx, jpy)) {
            return true;
        } else {
            return false;
        }
