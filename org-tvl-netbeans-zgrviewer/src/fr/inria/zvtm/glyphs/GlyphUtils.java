/*
 * FILE: GlyphUtils.java DATE OF CREATION: Thu Apr 17 16:02:27 2003 AUTHOR :
 * Emmanuel Pietriga (emmanuel@w3.org) MODIF: Thu Jul 10 16:10:14 2003 by
...
public class GlyphUtils {
    ...
    /**
     * returns a (basic) clone of Glyph g, returns null if g belongs to a class
     * that does not implement cloneable. Basic means that it copies the shape,
     * size, orientation and position, nothing more
     */
