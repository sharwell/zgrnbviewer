/*
 * Copyright (c) INRIA, 2010-2011. All Rights Reserved Licensed under the GNU
...
/**
 * A class that provides support for a basic form of semantic zooming. A
 * SemZoomGlyph instance is given a list of underlying glyph, and a list of
 * transition altitudes. When painting itself, the SemZoomGlyph delegates to the
 * appropriate underlying Glyph.
 */
