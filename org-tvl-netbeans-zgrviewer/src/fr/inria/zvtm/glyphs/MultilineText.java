...
/**
 * Multiline text. By default, text will be rendered on one line. Specifiy a
 * width constraint to make the text overflow on multiple lines. Specify a
 * height constraint to truncate the text. A height constraint is only
 * meaningful if a width constraint has been defined. The 'hot spot' of a
 * MultilineText instance is its top-left corner. This is unlike VText. Note:
 * setting a background color is unsupported.
 */
public class MultilineText extends VText {
    ...
    /**
     * Height constraint, in virtual space units. Text will be truncated if it
     * overflows the height constraint.
     */
    ...
    /**
     * Gets the width constraint for this MultilineText. A value of
     * Double.POSITIVE_INFINITY means that the width is unconstrained.
     */
