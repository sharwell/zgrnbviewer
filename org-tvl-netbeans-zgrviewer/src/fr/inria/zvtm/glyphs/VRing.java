 ...
 * 2008-2011. All Rights Reserved Licensed under the GNU LGPL. For full terms
...
public class VRing extends ClosedShape {
     ...
     *
     * @param x x-coordinate in virtual space of vertex that is not an arc
     * endpoint
     * @param y y-coordinate in virtual space of vertex that is not an arc
     * endpoint
     * @param z z-index (pass 0 if you do not use z-ordering)
     * @param vs arc radius in virtual space
     * @param ag arc angle in virtual space (in rad)
     * @param irr inner ring radius as a percentage of outer ring radius (from
     * center of ring); 0 to create a pie slice
     * @param or slice orientation in virtual space (interpreted as the
     * orientation of the segment linking the vertex that is not an arc endpoint
     * to the middle of the arc) (in rad)
     * @param c fill color
     ...
     * @param or slice orientation in virtual space (interpreted as the
     * orientation of the segment linking the vertex that is not an arc endpoint
     * to the middle of the arc) (in degrees)
     * @param c fill color
     * @param bc border color
     */
     ...
     *
     * @return slice's orientation in virtual space, interpreted as the
     * orientation of the segment linking the vertex that is not an arc endpoint
     * to the middle of the arc (bisector of the main angle). In [0:2Pi[
     */
    @Override
    ...
    public void addCamera(int verifIndex) {
        if (pr != null) {
            if (verifIndex == pr.length) {
                ...
                System.arraycopy(ta, 0, pr, 0, ta.length);
     ...
     *
     * @param ag slice orientation in virtual space, interpreted as the
     * orientation of the segment linking the vertex that is not an arc endpoint
     * to the middle of the arc (bisector of the main angle). In [0:2Pi[
     */
    @Override
