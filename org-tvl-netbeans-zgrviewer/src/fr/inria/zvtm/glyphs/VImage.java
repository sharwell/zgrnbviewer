/*
 * FILE: VImage.java DATE OF CREATION: Jan 09 2001 AUTHOR : Emmanuel Pietriga
...
/**
 * Bitmap Image. This version is the most efficient, but it cannot be reoriented
 * (see VImageOr).
 *
...
public class VImage extends ClosedShape implements RectangularShape {
    ...
    /**
     * Set to false if the image should not be scaled according to camera's
     * altitude. Its size can still be changed, but its apparent size will
     * always be the same, no matter the camera's altitude.
     *
     * @see #isZoomSensitive()
     */
    ...
    /**
     * Specify how image should be interpolated when drawn at a scale different
     * from its original scale.
     *
     * @param im one of
     * java.awt.RenderingHints.{VALUE_INTERPOLATION_NEAREST_NEIGHBOR,VALUE_INTERPOLATION_BILINEAR,VALUE_INTERPOLATION_BICUBIC}
     * ; default is VALUE_INTERPOLATION_NEAREST_NEIGHBOR
     */
    ...
    /**
     * Get information about how image should be interpolated when drawn at a
     * scale different from its original scale.
     *
     * @return one of
     * java.awt.RenderingHints.{VALUE_INTERPOLATION_NEAREST_NEIGHBOR,VALUE_INTERPOLATION_BILINEAR,VALUE_INTERPOLATION_BICUBIC}
     * ; default is VALUE_INTERPOLATION_NEAREST_NEIGHBOR
