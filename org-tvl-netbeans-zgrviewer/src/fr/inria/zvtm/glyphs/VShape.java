/*
 * FILE: VShape.java DATE OF CREATION: Aug 01 2001 AUTHOR : Emmanuel Pietriga
 ...
 * Computing, 2002. All Rights Reserved Copyright (c) INRIA, 2004-2010. All
 * Rights Reserved
 *
 ...
 * Defined by its N vertices (every vertex is between 0 (distance from shape's
 * center=0) and 1.0 (distance from shape's center equals bounding circle
 * radius)). Angle between each vertices is 2*Pi/N - can be reoriented.<br>
 *
...
public class VShape extends ClosedShape {
    ...
    /**
     * Vertex distances to the shape's center in the [0-1.0] range (relative to
     * bounding circle). Vertices are laid out counter clockwise, with the first
     * vertex placed at the same X coordinate as the shape's center (provided
     * orient=0).
     */
    float[] vertices;
    int[] xcoords;
    ...
    /**
     * @param v Vertex distances to the shape's center in the [0-1.0] range
     * (relative to bounding circle). Vertices are laid out counter clockwise,
     * with the first vertex placed at the same X coordinate as the shape's
     * center (provided orient=0).
     */
    ...
    /**
     * Get the list of vertex distances to the shape's center in the [0-1.0]
     * range (relative to bounding circle). Vertices are laid out counter
     * clockwise, with the first vertex placed at the same X coordinate as the
     * shape's center (provided orient=0).
     */
    ...
    /**
     * Get a serialization of the list of vertex distances to the shape's center
     * in the [0-1.0] range.
     *
     * @return a comma-separated string representation of the vertex distance to
     * the shape's center.
     */
    public String getVerticesAsText() {
        StringBuilder res = new StringBuilder();
        for (int i = 0; i < vertices.length - 1; i++) {
            res.append(vertices[i]).append(",");
        }
    ...
    @Override
    public Object clone() {
        VShape res = new VShape(vx, vy, vz, size, vertices.clone(), color, borderColor, orient);
