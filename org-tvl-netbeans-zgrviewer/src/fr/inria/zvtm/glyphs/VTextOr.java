/*
 * FILE: VTextOr.java DATE OF CREATION: Jan 11 2001 AUTHOR : Emmanuel Pietriga
 ...
 * Consortium. All Rights Reserved Copyright (c) INRIA, 2004-2010. All Rights
 * Reserved
 *
...
/**
 * Re-orientable Standalone Text. This version is less efficient than VText, but
 * it can be reoriented.<br> Font properties are set globally in the view, but
 * can be changed on a per-instance basis using setSpecialFont(Font f).<br> (vx,
 * vy) are the coordinates of the lower-left corner, or lower middle point, or
 * lower-right corner depending on the text anchor (start, middle, end).
 *
