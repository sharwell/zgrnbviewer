...
public class AdaptiveText extends VText {
    ...
    /**
     * Sets the shortener for this AdaptiveText. By default, a
     * PrefixTextShortener is used.
     */
     ...
     */
    @Override
    public void setZoomSensitive(boolean ignored) {
    }
    ...
    /**
     * Since we specify a width and height, visibility rules are easier than the
     * VText ones.
     */
    @Override
