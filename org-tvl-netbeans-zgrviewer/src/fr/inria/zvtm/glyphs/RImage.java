/*
 * Copyright (c) INRIA, 2004-2011. All Rights Reserved Licensed under the GNU
...
public class RImage extends VImage {
     ...
     * @param alpha alpha channel value in [0;1.0] 0 is fully transparent, 1 is
     * opaque
     * @param hir true if height measurement should include mirrored version of
     * the image (doubles the image's height) - defaults to false
     */
