/*
 * FILE: VPolygon.java DATE OF CREATION: Mon Jan 13 13:34:44 2003 AUTHOR :
...
/**
 * Polygon. Can be resized. Cannot be reoriented. This new implementation of
 * VPolygon models vertices as doubles internally to allow resizing without loss
 * of precision (and thus resizing to small sizes does not tamper with the
 * shape's aspect). It might be more memory consuming, and less efficient than
 * the original implementation, so the latter is still provided (class
 * FPolygon), for people who do not care about resizing polygons.
 *
 * @author Emmanuel Pietriga
 * @see fr.inria.zvtm.glyphs.FPolygon
 *
 */
public final class VPolygon extends ClosedShape {
