 ...
 *
 * $Id: LInfFSGaussianLens.java 2102 2009-06-23 08:57:56Z rprimet $
 */
 ...
 */
public class LInfFSGaussianLens extends FSGaussianLens {

    /**
     * create a lens with a maximum magnification factor of 2.0
     */
    public LInfFSGaussianLens() {
        super();
    }
     ...
     */
    public LInfFSGaussianLens(float mm) {
        super(mm);
    }
     ...
     */
    public LInfFSGaussianLens(float mm, int outerRadius, int innerRadius) {
     ...
     */
    public LInfFSGaussianLens(float mm, int outerRadius, int innerRadius, int x, int y) {
