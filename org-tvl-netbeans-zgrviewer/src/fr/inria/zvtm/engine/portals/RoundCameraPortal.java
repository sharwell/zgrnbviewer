/*
 * FILE: RoundCameraPortal.java DATE OF CREATION: Sun Jun 18 16:44:59 2006
 * AUTHOR : Emmanuel Pietriga (emmanuel.pietriga@inria.fr) MODIF: Emmanuel
 * Pietriga (emmanuel.pietriga@inria.fr) Copyright (c) INRIA, 2004-2010. All
...
/**
 * A portal showing what is seen through a camera. Shape: circular. The Camera
...
public class RoundCameraPortal extends CameraPortal {
     ...
     * camera portal. Although the region seen is actually an oval, we
     * approximate it to the bounding rectangle.
     *
