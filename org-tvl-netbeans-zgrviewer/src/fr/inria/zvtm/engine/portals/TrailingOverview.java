/*
 * FILE: TrailingOverview.java DATE OF CREATION: Mon Jul 10 14:07:06 2006 AUTHOR
 * : Emmanuel Pietriga (emmanuel.pietriga@inria.fr) MODIF: Emmanuel Pietriga
 * (emmanuel.pietriga@inria.fr) Copyright (c) INRIA, 2006-2010. All Rights
...
/**
 * A portal behaving as a trailing widget and showing what is seen through a
 * camera that serves as an overview. Shape: rectangular. The Camera should not
 * be used in any other View or Portal.
 */
public class TrailingOverview extends TrailingCameraPortal {
     ...
     * @param orc camera observing a region; this region is displayed as an
     ...
     * @param xo horizontal offset (in pixels) between cursor and portal
     * (trailing widget)
     * @param yo vertical offset (in pixels) between cursor and portal (trailing
     * widget)
     */
    ...
    /**
     * detects whether the given point is inside the observed region rectangle
     * depicting what is seen through the main camera
     *
