/*
 * FILE: TrailingCameraPortal.java DATE OF CREATION: Wed Jul 05 15:00:06 2006
 * AUTHOR : Caroline Appert (appert@lri.fr) MODIF: Emmanuel Pietriga
...
/**
 * A portal showing what is seen through a camera, with parameterable alpha
 * channel (translucency). The portal behaves like a trailing widget. The Camera
 * should not be used in any other View or Portal.
 */
public class TrailingCameraPortal extends CameraPortal {
    ...
    /**
     * Enable/disable update of trailing widget position when cursor does not
     * move at all.
     *
