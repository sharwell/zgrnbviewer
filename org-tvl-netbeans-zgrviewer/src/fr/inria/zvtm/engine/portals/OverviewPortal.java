/*
 * FILE: OverviewPortal.java DATE OF CREATION: Sat Jun 17 07:19:59 2006 AUTHOR :
 ...
 * Shape: rectangular. The Camera should not be used in any other View or
 * Portal.
 */
public class OverviewPortal extends CameraPortal {
    ...
    /**
     * For translucency of the rectangle representing the region observed
     * through the main viewport (default is 0.5)
     */
    AlphaComposite acST;
    /**
     * Alpha channel value.
    ...
    /**
     * Builds a new portal displaying what is seen through a camera and the
     * region seen through another camera.
     *
    ...
    /**
     * Is the given point inside the observed region rectangle depicting what is
     * seen through the main camera (viewfinder).
     *
