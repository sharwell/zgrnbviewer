/*
 * FILE: SpeedCoupling.java AUTHOR : Caroline Appert (appert@lri.fr) Olivier
 * Chapuis (chapuis@lri.fr) Emmanuel Pietriga (emmanuel.pietriga@inria.fr)
 * Copyright (c) Olivier Chapuis (chapuis@lri.fr) Licensed under the GNU LGPL.
