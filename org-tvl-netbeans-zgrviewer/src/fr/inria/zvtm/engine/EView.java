/*
 * FILE: EView.java DATE OF CREATION: Dec 27 2000 AUTHOR : Emmanuel Pietriga
 ...
 *
 * $Id: EView.java 4339 2011-03-08 15:22:49Z epietrig $
 */
...
/**
 * An external view (EView) is wrapped in a JFrame window and can be composed of
 * one or several cameras superimposed. Double buffering is implemented
 * manually, so as to enable offscreen buffer modifications after rendering but
 * before painting on screen, such as when magnifying a region with a Lens.
 *
...
public class EView extends View implements KeyListener {
     ...
     */
    protected EView(String viewType, List<Camera> v, String t, int w, int h,
     ...
     * @param decorated should the view be decorated with the underlying window
     * manager's window frame or not
     * @param mnb a menu bar, already configured with actionListeners already
     * attached to items (it is just added to the view). No effect if null.
     */
