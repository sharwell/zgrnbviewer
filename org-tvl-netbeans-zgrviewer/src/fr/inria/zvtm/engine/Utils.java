/*
 * FILE: Java2DPainter.java DATE OF CREATION: Fri Aug 26 09:31:59 2005 AUTHOR :
...
public class Utils {
    ...
    private static final HashMap<String, Color> COLORS_BY_KW = new HashMap<String, Color>();
    ...
    /**
     * Get the Java AWT color which corresponds to a color keyword as defined in
     * <a
     * href="http://www.w3.org/TR/SVG/types.html#ColorKeywords">http://www.w3.org/TR/SVG/types.html#ColorKeywords</a>.
     *
     * @param keyword a color keyword name such as black, blue, lime,
     * darkorchid, etc...
     */
    ...
    /*
     * takes an array of floats and returns a single string containing all
    ...
    /**
     * Checks whether Glyph array ga contains glyph g or not within its first N
     * items.
     *
    ...
    /**
     * Checks whether Glyph array ga contains glyph g or not and returns its
     * index.
     */
    ...
    /**
     * Returns a diagonal gradient centered around a color (upper left corner is
     * lighter, lower right corner is darker)
     *
