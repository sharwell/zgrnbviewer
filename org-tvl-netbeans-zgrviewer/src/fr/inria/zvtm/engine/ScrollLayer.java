 ...
 * 2007-2011. All Rights Reserved Licensed under the GNU LGPL. For full terms
...
public class ScrollLayer implements ComponentListener {
     ...
     *
     * @param cc camera that will be controlled by these scroll bars
     * @param widgets list of widgets that should be used to represent the
     * scrollbar components (if you want to customize their look and feel). The
     * glyphs should not be added to any virtual space (this is taken care of
     * internally). All glyphs should implement interface RectangularShape.
     * Provide the glyphs in the following order: vertical scroll bar gutter,
     * slider, up button, down button, horizontal scroll bar gutter, slider,
    ...
    /**
     * Call this method whenever you add or remove objects from the virtual
     * space containing the controlled camera. It should also be called when the
     * position or size of glyphs in that virtual space change (in case these
     * modifications change the bounds of the smallest region of the virtual
     * space containing all glyphs).
     */
    ...
    /**
     * Call this method whener the controlled camera's position / altitude
     * changes. (as a result of actions others than scroll bar manipulations).
     */
    ...
    /**
     * Call this method directly if scroll bars should be updated for reasons
     * other than changes to glyphs in the controlled camera's virtual space or
     * changes to that camera itself.
     *
     * @see #cameraUpdated()
    ...
    public void updateVerticalScrollBar() {
        ...
        double ratio = observedHeight / totalHeight;
    ...
    public void updateHorizontalScrollBar() {
        ...
        double ratio = observedWidth / totalWidth;
    ...
    /**
     * Tells whether the given point is inside the area containing the scroll
     * bars or not.
     *
     * @param cx provide projected JPanel coordinates of the associated view,
     * not virtual space coordinates
     * @param cy provide projected JPanel coordinates of the associated view,
     * not virtual space coordinates
     */
    public boolean cursorInside(int cx, int cy) {
        double coef = ((slC.focal + slC.altitude) / slC.focal);
    ...
    /**
     * Get the internal camera managed by this ScrollLayer to display the scroll
     * bar glyphs.
     *
     * @return the camera that should be added in the view in to create the
     * scroll bar layer.
     */
    ...
    /**
     * Call this method when the horizontal slider is manipulated (e.g.,
     * dragged) through the user interface.
     *
     * @param dx the horizontal translation that will be applied to the slider
     * (negative values translate it left, positive values right)
     */
    ...
    /**
     * Call this method when the vertical slider is manipulated (e.g., dragged)
     * through the user interface.
     *
     * @param dy the vertical translation that will be applied to the slider
     * (negative values translate it down, positive values up)
     */
    ...
    /**
     * Call this method when the UP button of the vertical scrollbar is
     * actuated.
     */
    public void moveUp() {
    ...
    /**
     * Call this method when the DOWN button of the vertical scrollbar is
     * actuated.
     */
    ...
    /**
     * Call this method when the LEFT button of the horizontal scrollbar is
     * actuated.
     */
    ...
    /**
     * Call this method when the RIGHT button of the horizontal scrollbar is
     * actuated.
     */
    ...
    /**
     * Make scroll bars fade in/out (gradually appear/disappear). Make sure
     * glyphs used to represent scrollbar widgets implement the Translucent
     * interface.
     */
