...
public class DynaPicker {
     ...
     */
    Map<Glyph, Object> gida = new HashMap<Glyph, Object>(20);
    int DYNASPOT_MAX_RADIUS = 16;
    int LAG_TIME = 120;
    int REDUC_TIME = 180;
    Color DYNASPOT_COLOR = Color.LIGHT_GRAY;
    float DYNASPOT_MAX_TRANSLUCENCY = 0.3f;
    AlphaComposite dsST = AlphaComposite.getInstance(AlphaComposite.SRC_OVER, DYNASPOT_MAX_TRANSLUCENCY);
    /**
    ...
    /**
     * The DynaSpot area is invisible when the cursor is still, and gradually
     * fades in when the cursor moves.
     */
    public static final short DYNASPOT_VISIBILITY_FADEIN = 2;
    /**
     * The DynaSpot area is visible when the cursor is still, and gradually
     * fades out when the cursor moves.
     */
    ...
    /**
     * Set DynaSpot lag parameter. See <a
    ...
    /**
     * Get DynaSpot lag parameter. See <a
     * href="http://zvtm.sourceforge.net/doc/dynaspot.html">http://zvtm.sourceforge.net/doc/dynaspot.html</a>
     * for more detail.
     */
    ...
    /**
     * Set DynaSpot reduction time parameter. See <a
     * href="http://zvtm.sourceforge.net/doc/dynaspot.html">http://zvtm.sourceforge.net/doc/dynaspot.html</a>
     * for more detail.
     */
    ...
    /**
     * Get DynaSpot reduction time parameter. See <a
     * href="http://zvtm.sourceforge.net/doc/dynaspot.html">http://zvtm.sourceforge.net/doc/dynaspot.html</a>
     * for more detail.
     */
     ...
     *
     * @param currentTime current absolute time, obtained from
    ...
    /**
     * Get DynaSpot's current radius. See <a
     * href="http://zvtm.sourceforge.net/doc/dynaspot.html">http://zvtm.sourceforge.net/doc/dynaspot.html</a>
     * for more detail.
     */
    ...
    /**
     * Set maximum size of DynaSpot selection region. See <a
     * href="http://zvtm.sourceforge.net/doc/dynaspot.html">http://zvtm.sourceforge.net/doc/dynaspot.html</a>
     * for more detail.
     */
    ...
    /**
     * Get maximum size of DynaSpot selection region. See <a
     * href="http://zvtm.sourceforge.net/doc/dynaspot.html">http://zvtm.sourceforge.net/doc/dynaspot.html</a>
     * for more detail.
     */
    ...
    /**
     * Set a Selection Listener callback triggered when a glyph gets
     * selected/unselected by DynaSpot.
     *
    ...
    /**
     * Get the Selection Listener callback triggered when a glyph gets
     * selected/unselected by DynaSpot.
     *
    ...
    /**
     * Get the set of glyphs intersected by the cursor's dynaspot region. See <a
     * href="http://zvtm.sourceforge.net/doc/dynaspot.html">http://zvtm.sourceforge.net/doc/dynaspot.html</a>
     * for more detail.
     *
     ...
     * @see #dynaPick(Camera c)
     */
    public Set<Glyph> getGlyphsInDynaSpotRegion(Camera c) {
        return gida.keySet();
    }
