/*
 * FILE: Transitions.java DATE OF CREATION: Sun Mar 04 10:59:11 2007 AUTHOR :
 * Emmanuel Pietriga (emmanuel.pietriga@inria.fr) MODIF: Emmanuel Pietriga
 * (emmanuel.pietriga@inria.fr) Copyright (c) INRIA, 2007-2010. All Rights
...
/**
 * Creation and management of transition animations such as fade in/fade out for
 * views.
 *
...
public class Transitions {
    ...
    /**
     * Makes a view fade out, and eventually be painted blank. The view must not
     * be blank for the fade out to work.
     *
    ...
    public static void fadeOut(final View v, int duration, final Color fadeColor, final EndAction action) {
        ...
        Animation trans = VirtualSpaceManager.INSTANCE.getAnimationManager().getAnimationFactory().createTranslucencyAnim(duration, fadeRect,
    ...
    /**
     * Makes a view (originally blank) fade in. The view must be blank for the
     * fade in to work.
     *
