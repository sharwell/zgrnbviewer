...
/**
 * This class represents an animation. An Animation has a subject (object that
 * will be animated e.g. Glyph, Camera, Portal...) and a dimension
 * (characteristic that will be animated e.g. position, color, altitude...).
 * Animation management (creating, starting, stopping, pausing or cancelling
 * animations) is done by the {@link AnimationManager}.
 *
 * @see TimingHandler
...
public class Animation {
    ...
    public static enum Dimension {
        ...
        POSITION, ALTITUDE, SIZE, ORIENTATION,
    ...
    /**
     * Two or more Animations can be run concurrently if and only if they are
     * orthogonal. Two Animations are said to be orthogonal if they either
     * target different subjects or have different dimensions.
     *
     * Non-orthogonal animations get queued and run in the order in which they
     * were started.
     */
