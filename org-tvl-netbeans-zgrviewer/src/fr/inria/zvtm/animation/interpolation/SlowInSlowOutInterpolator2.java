...
/**
 * A class that implements a more pronounced slow in, slow out interpolation, as
 * was available in the old animation engine of 0.9.x.
 *
...
public class SlowInSlowOutInterpolator2 {
     ...
     * Returns Interpolator instance
     *
     * @param sigFactor "steepness" of the sigmoid (slow-in/slow-out spline).
     * Default value is 4. The higher the value, the more pronounced the
     * acceleration/deceleration will be.
     * @return an Interpolator that implements a more pronounced slow in, slow
     * out interpolation
     */
