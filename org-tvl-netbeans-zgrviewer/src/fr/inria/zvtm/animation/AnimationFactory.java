 ...
 * Automatique), 2009-2011. Licensed under the GNU LGPL. For full terms see the
 * file COPYING.
 *
...
/**
 * A class that provides creation methods for animations. The createAnimation()
 * methods are generic and flexible, while the create[TargetType][AnimationType]
 * methods are pre-made and easier to use (but offer less flexibility and only
 * cover the most common animation cases).
 */
@Immutable
public class AnimationFactory {
    ...
    /**
     * Creates a new Animation object that will be handled by the associated
     * AnimationManager.
     *
     * @param duration duration of the animation, in milliseconds. duration may
     * be set to Animation.INFINITE, in which case the animation will run
     * indefinitely. In that case, the fraction passed to the timingEvent method
     * of the handler is meaningless.
     ...
     * times. repeatCount may be set to Animation.INFINITE, in which case the
     * animation will be repeated indefinitely.
     ...
     * @param data animation data, interpreted according to the 'relative'
     * boolean argument. If 'relative' is false, then 'data' will be interpreted
     * as absolute target coordinates, otherwise it will be interpreted as an
     * offset.
     ...
     * @param endAction a functor that will be executed when the animation ends.
     * May be set to null, in which case it is ignored.
     * @see EndAction
     */
     ...
     * @param data animation data, interpreted according to the 'relative'
     * boolean argument. If 'relative' is false, then 'data' will be interpreted
     * as an absolute target altitude, otherwise it will be interpreted as an
     * offset.
     * @param relative true if 'data' is to be interpreted relatively.
     * @param interpolator Interpolator that governs the time behavior of the
     * animation (constant speed, constant acceleration, slow in/slow out...)
     ...
     * @param duration duration of the animation, in milliseconds.
     * @param glyph glyph to animate
     * @param data animation data (size or size offset), interpreted according
     * to the 'relative' boolean argument. If 'relative' is false, then 'data'
     * will be interpreted as an absolute size, otherwise it will be interpreted
     * as a size offset.
     * @param relative true if 'data' is to be interpreted relatively.
     * @param interpolator Interpolator that governs the time behavior of the
     * animation (constant speed, constant acceleration, slow in/slow out...)
     ...
     * interpreted according to the 'relative' boolean argument. If 'relative'
     * is false, then 'data' will be interpreted as an absolute orientation,
     ...
     * interpreted according to the 'relative' boolean argument. If 'relative'
     * is false, then 'data' will be interpreted as an absolute color, otherwise
     * it will be interpreted as a color offset. 'data' should be an array of
     * size 3, containing the hue, saturation and brightness, in order. H, S,
     * and V are in the interval [0, 1]
     * @param relative true if 'data' is to be interpreted relatively.
     * @param interpolator Interpolator that governs the time behavior of the
     * animation (constant speed, constant acceleration, slow in/slow out...)
     * @param endAction a functor that will be executed when the animation ends.
    ...
    /**
     * Creates and returns an animation that targets the alpha property of a
     * Translucent object
     *
     * @param duration duration of the animation, in milliseconds.
     * @param translucent Translucent object to animate
     * @param data animation data (alpha value or offset, in [0, 1] - 0 means
     * transparent and 1 opaque), interpreted according to the 'relative'
     * boolean argument. If 'relative' is false, then 'data' will be interpreted
     * as an absolute opacity, otherwise it will be interpreted as an opacity
     * offset.
     * @param relative true if 'data' is to be interpreted relatively.
     * @param interpolator Interpolator that governs the time behavior of the
     * animation (constant speed, constant acceleration, slow in/slow out...)
     ...
     * @param duration duration of the animation, in milliseconds.
     * @param portal portal to animate
     * @param wdata animation data, interpreted according to the 'relative'
     * boolean argument. If 'relative' is false, then 'wdata' will be
     * interpreted as an absolute width, otherwise it will be interpreted as an
     * offset.
     * @param hdata animation data, interpreted according to the 'relative'
     * boolean argument. If 'relative' is false, then 'hdata' will be
     * interpreted as an absolute height, otherwise it will be interpreted as an
     * offset.
     * @param relative true if 'data' is to be interpreted relatively.
     * @param interpolator Interpolator that governs the time behavior of the
     * animation (constant speed, constant acceleration, slow in/slow out...)
     ...
     * @param data animation data, interpreted according to the 'relative'
     * boolean argument. If 'relative' is false, then 'data' will be interpreted
     * as an absolute maximum magnification factor, otherwise it will be
    ...
    /**
     * Creates and returns a lens magnification and radii animation that will
     * not repeat.
     *
     * @param duration duration of the animation, in milliseconds.
     * @param lens lens to animate
     * @param magData target max magnification factor (absolute value or offset,
     * depending on 'relative')
     * @param orData target outer radius (absolute value or offset, depending on
     * 'relative'), in view coordinates
     * @param irData target inner radius (absolute value or offset, depending on
     * 'relative'), in view coordinates Warning: outer radius and magnification
     * should change in the same direction (both should either increase or
     * decrease), otherwise the behavior of the resulting Animation is undefined
     * @param relative true if 'data' is to be interpreted relatively.
     * @param interpolator Interpolator that governs the time behavior of the
     * animation (constant speed, constant acceleration, slow in/slow out...)
     * @param endAction a functor that will be executed when the animation ends.
