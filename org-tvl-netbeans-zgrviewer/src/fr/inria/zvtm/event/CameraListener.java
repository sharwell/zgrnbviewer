...
public interface CameraListener {
    ...
    /**
     * Called back when a Camera is moved. Callback handlers are expected to be
     * thread-safe. Do not perform blocking or time consuming tasks within the
     * handler. It is a bad idea to move the target Camera in a handler
     * (infinite loop). Moving other Cameras is also probably a bad idea. To
     * receive notifications, clients should register themselves using
     * Camera.addListener
     *
