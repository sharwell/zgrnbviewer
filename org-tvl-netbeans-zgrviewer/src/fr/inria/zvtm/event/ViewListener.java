/*
 * FILE: ViewListener.java DATE OF CREATION: Fri May 26 15:01:11 2006 AUTHOR :
...
public interface ViewListener {
     ...
     * @param mod key modifiers depressed when event occured. One of
     * NO_MODIFIER, SHIFT_MOD, CTRL_MOD, CTRL_SHIFT_MOD, META_MOD,
     * META_SHIFT_MOD, ALT_MOD, ALT_SHIFT_MOD.
     * @param jpx x-coordinate of cursor in JPanel coordinates when event
     * occured.
     * @param jpy y-coordinate of cursor in JPanel coordinates when event
     * occured.
     ...
     */
    /**
     * Mouse moved callback. This callback can be enabled/disabled using
     * View.setNotifyCursorMoved(). Active by default.
     *
     * @param v ViewPanel/JPanel embedded in View, on which glyphs are drawn.
     * @param jpx x-coordinate of cursor in JPanel coordinates when event
     * occured.
     ...
     */
    /**
     * Key typed event. Beware: code is always 0 in Ktype (it is the value of
     * KeyEvent.getKeyCode() which is always equal to VK_UNDEFINED according to
     * Sun). If you need to access code, use Kpress or Krelease.
     *
     * @param v ViewPanel/JPanel embedded in View, on which glyphs are drawn.
     * @param c char typed.
